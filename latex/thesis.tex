...
\pubyear{2023}
\pubmonth{6}
\publab{Tietojenkäsittelytieteet}
...
\input{johdanto.tex}
\input{perinteinen-arkkitehtuuri.tex}
\input{palvelimeton-arkkitehtuuri.tex}
\input{vaikutukset-kehitysprosessiin.tex}
\input{skaalautuvuus.tex}
\input{tietoturva.tex}
